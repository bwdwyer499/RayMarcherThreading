.\Release\Stage1.exe -runs 1 -threads 8 -output Outputs/stage1_03.bmp -input Scenes/all.txt -size 500 300 -samples 1
.\Release\Stage1.exe -runs 1 -threads 8 -output Outputs/stage1_05.bmp -input Scenes/5000spheres.txt -size 240 135 -samples 1

.\Release\Stage1.exe -runs 1 -threads 3   -input Scenes/all.txt -size 1024 1024 -samples 1   -output Outputs/all.txt_1024x1024x1_Stage1.exe_3.bmp
.\Release\Stage1.exe -runs 1 -threads 5   -input Scenes/all.txt -size 1024 1024 -samples 1   -output Outputs/all.txt_1024x1024x1_Stage1.exe_5.bmp
.\Release\Stage1.exe -runs 1 -threads 6   -input Scenes/all.txt -size 1024 1024 -samples 1   -output Outputs/all.txt_1024x1024x1_Stage1.exe_6.bmp
.\Release\Stage1.exe -runs 1 -threads 7   -input Scenes/all.txt -size 1024 1024 -samples 1   -output Outputs/all.txt_1024x1024x1_Stage1.exe_7.bmp
.\Release\Stage1.exe -runs 1 -threads 513 -input Scenes/all.txt -size 1024 1024 -samples 1   -output Outputs/all.txt_1024x1024x1_Stage1.exe_513.bmp
