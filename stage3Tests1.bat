.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 8  -debugProgress -output Outputs/stage3_01_8.bmp -input Scenes/all.txt -size 1024 1024 -samples 1
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 8  -debugProgress -output Outputs/stage3_02_8.bmp -input Scenes/all.txt -size 1024 1024 -samples 4
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 8  -debugProgress -output Outputs/stage3_04_8.bmp -input Scenes/cornell.txt -size 1024 1024 -samples 1
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 8  -debugProgress -output Outputs/stage3_06_8.bmp -input Scenes/sponge.txt -size 128 128 -samples 1
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 64 -debugProgress -output Outputs/stage3_01_64.bmp -input Scenes/all.txt -size 1024 1024 -samples 1
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 64 -debugProgress -output Outputs/stage3_02_64.bmp -input Scenes/all.txt -size 1024 1024 -samples 4
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 64 -debugProgress -output Outputs/stage3_04_64.bmp -input Scenes/cornell.txt -size 1024 1024 -samples 1
.\Release\Stage3.exe -runs 1 -threads 8 -blockSize 64 -debugProgress -output Outputs/stage3_06_64.bmp -input Scenes/sponge.txt -size 128 128 -samples 1
