.\Release\Stage2.exe -runs 1 -threads 8 -output Outputs/stage2_01.bmp -input Scenes/all.txt -size 1024 1024 -samples 1
.\Release\Stage2.exe -runs 1 -threads 8 -output Outputs/stage2_02.bmp -input Scenes/all.txt -size 1024 1024 -samples 4
.\Release\Stage2.exe -runs 1 -threads 8 -output Outputs/stage2_03.bmp -input Scenes/all.txt -size 500 300 -samples 1
.\Release\Stage2.exe -runs 1 -threads 8 -output Outputs/stage2_04.bmp -input Scenes/cornell.txt -size 1024 1024 -samples 1
.\Release\Stage2.exe -runs 1 -threads 8 -output Outputs/stage2_05.bmp -input Scenes/5000spheres.txt -size 240 135 -samples 1
.\Release\Stage2.exe -runs 1 -threads 8 -output Outputs/stage2_06.bmp -input Scenes/sponge.txt -size 128 128 -samples 1
